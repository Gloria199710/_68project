...
$(document).ready(function(){
    ...
    $(window).scroll(function(){
        if( $(window).scrollTop() > stickyHeaderTop ) {
                ...
                // $('#columns').css( "margin-top", "140px" );
                $('#topbar').css({position: 'fixed', width:'100%'});
                $('#site_logo').css({width: '150px'});
                $('#ves-mainnav').css({top: '5px'});
                $('.logo').css({top: '-5px'});
                $('#header .header-default2 #header-main').css({padding: '17px 0', top: '45px'});
        } else {
                $('#header').css({ top: '0px', width:'100%', position:'relative'});
                // $('#columns').css( "margin-top", "0" );
                $('#site_logo').css({width: '258px'});
                $('#ves-mainnav').css({top: '44px', bottom:'44px'});
                $('.logo').css({top: '0'});
                $('#header .header-default2 #header-main').css({padding: '19px 0'});
                $('.layerslider-wrapper').css({margin:'55px auto 0'});
...
$(document).ready(function(){
    ...
    $('.cms-68black .locations .btn').each(function() {
